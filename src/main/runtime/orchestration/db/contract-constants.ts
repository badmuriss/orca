...
// v30 adds the active-dispatch guard; v31-v34 add Maestro documents, leases, close intents, and browser surfaces.
// v35 adds Task purpose/operational outcomes and review-retained worker resources; v36 adds durable Browser profile consent receipts.
